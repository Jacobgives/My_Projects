...
def studyfleck():
    _title = "Look how far you've come. All the world's wonders and you stand today, studying a fleck."
    _content = "While staring at the fleck, you feel fatigued."
    _link1 = "/pattern"
    _link2 = "/chaos"
    _link1content = "Study the fleck further."
    _link2content = "Blankly look at the fleck."
    return render_template('index.html', title=_title, content=_content, link1=_link1, link2=_link2, link1_content=_link1content, link2_content=_link2content)


@app.route('/pattern')
def studypattern():
    _title = "You notice a pattern."
    _content = "You notice an underlying pattern in the geometry of the fleck and it teaches you a way to calculate the inner and outer intricacies of the fleck."
    _link1 = "/pattern"
    _link2 = "/chaos"
    _link1content = ""
    _link2content = ""
...
@app.route('/chaos')
def studychaos():
    _title = "You notice only chaos."
    _content = "You notice only chaos. You assume there is no finite shape to the fleck and are confused by the greater workings of the universe."
    _link1 = "/pattern"
    _link2 = "/chaos"
    _link1content = ""
    _link2content = ""
